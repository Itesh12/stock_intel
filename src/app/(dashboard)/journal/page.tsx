...
export default function JournalPage() {
    return (
        <div className="max-w-4xl mx-auto py-4 md:py-8 px-4 sm:px-6 pb-20">
            <div className="mb-10 text-center">
                ...
                <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white tracking-tighter mb-4">Trader <span className="text-blue-500">Journal</span></h1>
            ...
            <div className="bg-white/[0.03] border border-white/5 rounded-[32px] p-5 md:p-8">
                <TraderJournal />
            </div>
        </div>
    );
