        ...
        <div className="min-h-screen bg-[#050505] flex flex-col items-center justify-center p-6 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-blue-900/10 via-transparent to-transparent">
            <div className="w-full max-w-md animate-in fade-in slide-in-from-bottom-4 duration-1000">
                ...
                <div className="glass-card p-10 relative overflow-hidden group">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group/input">
                                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <User size={18} className="text-slate-500 group-focus-within/input:text-blue-500 transition-colors" />
                                </div>
                                <input
                                    type="text"
                                    value={name}
                    ...
                    <div className="mt-8 text-[11px] text-slate-500 text-center leading-relaxed font-medium">
                        By creating an account, you agree to our <span className="text-blue-400 underline underline-offset-4 cursor-pointer">Terms of Service</span> and <span className="text-blue-400 underline underline-offset-4 cursor-pointer">Privacy Policy</span>.
                    </div>
                </div>

                <p className="mt-8 text-center text-sm text-slate-500">
                    Already have an account? <Link href="/auth/login" className="text-blue-500 font-bold hover:text-blue-300 transition-colors">Sign In</Link>
                </p>
            </div>
        </div>
    );
